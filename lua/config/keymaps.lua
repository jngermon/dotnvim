...
map("n", "<C-m>", "<C-w>l", { desc = "Go to Right Window", remap = true })
...
-- Move Lines
map("n", "<A-r>", "<cmd>execute 'move .+' . v:count1<cr>==", { desc = "Move Down" })
map("n", "<A-n>", "<cmd>execute 'move .-' . (v:count1 + 1)<cr>==", { desc = "Move Up" })
map("i", "<A-r>", "<esc><cmd>m .+1<cr>==gi", { desc = "Move Down" })
map("i", "<A-n>", "<esc><cmd>m .-2<cr>==gi", { desc = "Move Up" })
map("v", "<A-r>", ":<C-u>execute \"'<,'>move '>+\" . v:count1<cr>gv=gv", { desc = "Move Down" })
map("v", "<A-n>", ":<C-u>execute \"'<,'>move '<-\" . (v:count1 + 1)<cr>gv=gv", { desc = "Move Up" })
